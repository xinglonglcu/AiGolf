 ...
 * on 2019-07-30 14:31
 */
public class RCRatioFrameLayout extends RatioFrameLayout implements Checkable, RCAttrs {
    RCHelper mRCHelper;

    public RCRatioFrameLayout(Context context) {
        this(context, null);
    }

    public RCRatioFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RCRatioFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
