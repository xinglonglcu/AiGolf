...
public class SuperSwipeRefreshLayout extends ViewGroup implements OnPullAgent{
    private static final String LOG_TAG = "CustomeSwipeRefreshLayout";
    private static final int HEADER_VIEW_HEIGHT = 60;// HeaderView height (dp)
    ...
    public SuperSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        mFooterViewHeight = (int) (1 * metrics.density);
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mIsBeingDragged) {
                    ...
                    if (overscrollTop < mTotalDragDistance) {
                        ...
                        onAgentPullEnable(false);
                    } else {
                        if (mListener != null) {
                            mListener.onPullEnable(true);
                        }
                        onAgentPullEnable(true);
                    }
