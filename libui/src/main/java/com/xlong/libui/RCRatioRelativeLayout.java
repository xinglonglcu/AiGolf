 ...
 * on 2019-07-30 14:31
 */
public class RCRatioRelativeLayout extends RelativeLayout implements Checkable, RCAttrs {
    RCHelper mRCHelper;

    public RCRatioRelativeLayout(Context context) {
        this(context, null);
    }

    public RCRatioRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RCRatioRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
